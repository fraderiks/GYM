...
<body class="bg-gray-100 text-gray-800 font-sans min-h-screen flex flex-col bg-cover bg-center" style="background-image: url('foto/gym.jpg')">
  ...
  <main class="flex-grow flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8 bg-white p-8 rounded-lg shadow-lg">
      ...
      <form class="mt-8 space-y-6" method="post" action="{{ route('authenticate') }}">
        @csrf
      ...
      <div class="text-sm text-center text-gray-600">
        ...
        <br>
        <a href="{{ route('homepage.index') }}" class="mt-2 block font-medium text-indigo-600 hover:text-indigo-500">Back to Homepage</a>
      </div>
